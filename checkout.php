      ...
      <div class="col-lg-6 px-4 pb-4" id="order">
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            <input type="tel" name="phone" id="phone-input" class="form-control" placeholder="Enter Phone" pattern="01(1|5|6|7|8|9)[0-9]{8}" required>
            <div id="phone-error" style="color: red;"></div>
          </div>


          <div class="form-group">
            <select id="level1" name="pmode1" class="form-control" required>
          ...
          <div class="form-group">
            <select id="level2" name="pmode2" class="form-control" required>
              <option value="" selected disabled>Select Your Subdistrict</option>
            </select>
          </div>
          <div class="form-group">
            <select id="level3" name="pmode3" class="form-control" required>
  ...
  <script>
    ...
    phoneInput.addEventListener('input', function() {
      if (!phoneInput.validity.valid) {
        phoneError.textContent = 'Please enter a valid Bangladeshi phone number.';
      } else {
